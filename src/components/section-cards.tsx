...
export function SectionCards() {
    ...
    const card01Ref = useRef()
    const card02Ref = useRef()
    const card03Ref = useRef()
    const card04Ref = useRef()
    const card05Ref = useRef()
    const card06Ref = useRef()
    ...
    return (
        ...
        <section className='w-full pb-20' ref={sectionRef}>
            ...
            <h2 className='text-center text-7xl font-semibold text-black mb-56' ref={titleRef}>Faça 
